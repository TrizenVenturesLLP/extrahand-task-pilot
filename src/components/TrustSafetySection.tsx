      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {trustFeatures.slice(0, 4).map((feature, idx) => (
              <div
                key={idx}
                className="flex items-start gap-6 rounded-3xl shadow-lg bg-[#f7f8fd] p-8 transition-all duration-200 hover:shadow-2xl border border-gray-100 min-h-[180px]"
              >
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-primary/10 text-primary shrink-0">
                  <feature.icon className="w-8 h-8" />
                </div>
                <div>
                  <h3 className="text-2xl font-extrabold text-gray-800 leading-tight mb-2">
                    {feature.title}
                  </h3>
          ...
          <div className="flex justify-center mt-8">
            <div className="flex items-start gap-6 rounded-3xl shadow-lg bg-[#f7f8fd] p-8 transition-all duration-200 hover:shadow-2xl border border-gray-100 min-h-[180px] w-full max-w-2xl">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-primary/10 text-primary shrink-0">
                {React.createElement(trustFeatures[4].icon, { className: "w-8 h-8" })}
              </div>
              <div>
                <h3 className="text-2xl font-extrabold text-gray-800 leading-tight mb-2">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <button className="bg-gradient-hero text-black px-6 py-3 rounded-lg font-semibold hover:shadow-md transition-all duration-300">
              Start Your First Task
            </button>
            <button className="border-2 border-secondary text-secondary px-6 py-3 rounded-lg font-semibold hover:bg-secondary hover:text-white transition duration-300">
              Learn More
            </button>
          </div>
        </div>
